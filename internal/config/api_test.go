...
// 			api := &API{}
// 			err := json.NewDecoder(strings.NewReader(tc.conf)).Decode(&api)
...
// 	]`)
// 	srv := &API{}
// 	srv.AddInputValidator(validator.Any{})
// 	err := srv.Parse(r)
// 	if err != nil {
// 		t.Fatalf("unexpected error: %q", err)
// 	}
...
// 		{
// 			name: "in as out",
// 			in:   []validator.Type{validator.Bool{}},
// 			out:  map[string]interface{}{},
// 			config: `[{
// 				"method": "GET",
// 				"path": "/",
...
// 	srv := &API{}
// 	srv.AddInputValidator(validator.Any{})
// 	srv.AddInputValidator(validator.Bool{})
// 	err := srv.Parse(r)
// 	if err != nil {
// 		t.Fatalf("unexpected error: %q", err)
// 	}
...
// 			Description: "info",
// 			Type:        t,
// 			GoType:      validator.String{}.GoType(),
// 			Validator:   validator.String{}.Validator(t),
// 			Rename:      strings.TrimSuffix(strings.TrimPrefix(k, "{"), "}"),
// 		}
// 		if t == "bool" {
// 			parameters[k].GoType = validator.Bool{}.GoType()
// 			parameters[k].Validator = validator.Bool{}.Validator(t)
// 		}
// 	}
...
// 		t.Run(tc.name, func(t *testing.T) {
// 			srv := &API{}
// 			srv.AddInputValidator(validator.String{})
// 			srv.AddInputValidator(validator.Uint{})
...
// 			srv := &API{}
// 			srv.AddInputValidator(validator.Any{})
// 			srv.AddInputValidator(validator.Int{})
// 			srv.AddInputValidator(validator.Bool{})
// 			err := srv.Parse(strings.NewReader(tc.conf))
